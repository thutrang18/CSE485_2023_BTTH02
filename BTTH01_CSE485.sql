...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th2 25, 2023 lúc 08:51 AM
...
CREATE TABLE `baiviet` (
  `ma_bviet` int(30) UNSIGNED NOT NULL,
  ...
  `ma_tloai` int(35) UNSIGNED NOT NULL,
  ...
  `ma_tgia` int(35) UNSIGNED NOT NULL,
...
CREATE TABLE `theloai` (
  `ma_tloai` int(30) UNSIGNED NOT NULL,
